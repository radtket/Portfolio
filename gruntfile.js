module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
        ...
        dev: {
            src: ['src/js/vendor/jquery-1.11.2.min.js', 'src/js/vendor/jquery-migrate-1.2.1.min', 'src/js/vendor/bootstrap.js', 'src/js/vendor/jquery.easing.1.3.js', 'src/js/vendor/isotope.js', 'src/scss/slick/slick.js', 'src/js/vendor/jquery.singlePageNav.js', 'src/js/vendor/jquery.sticky.js', 'src/js/plugins.js', 'src/js/main.js'],

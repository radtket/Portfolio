...
if($_POST)
{
    $to_Email       = "info@taylorradtke.com"; // Replace with recipient email address
    $subject        = 'Message from my website'; // Subject line for emails
    
    $host           = "octopus.arvixe.com"; // Your SMTP server. For example, smtp.mail.yahoo.com
    $username       = "info@taylorradtke.com"; //For example, your.email@yahoo.com
    $password       = "defence1"; // Your password
    ...
    if(strlen($user_Subject)<1) // If length is less than 1 it will throw an HTTP error.
    {
